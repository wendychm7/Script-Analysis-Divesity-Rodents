##Statistical parameters analysis: Maximum, minimum, mean, median by indice and region
...
stats_protected <- base %>%
  ...
  summarise(
    ...
    FD_mean = mean(FD, na.rm = TRUE),
    FD_median = median(FD, na.rm = TRUE))
##View results by Protection Status
