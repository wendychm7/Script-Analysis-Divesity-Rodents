...
library(sf)
library(raster)
##Loads the polygon SHP of the species you need to fix
##Example
specie<-st_read("C:/Working Directory...polygon1.shp")
#verify the validity of geometry
st_is_valid(specie)
...
##intersection of polygon with map of Chile
polygon_chile <- st_intersection(st_geometry(polygon), st_geometry(chle))
